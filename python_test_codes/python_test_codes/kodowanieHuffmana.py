...
def kodowanieHuffmana(alfabet, prawdobodopienstwa, ciagDoZakodowania):
    ...
    for x in ciagDoZakodowania:
        for klucz, wartosc in ostateczneKodowania.items():
            if x == klucz:
                zakodowany = zakodowany + wartosc
    print("Zakodowany ciag: ")
    print(zakodowany)
doZakodowania = "ADABAC"
kodowanieHuffmana(["A","B","C","D"], [0.3,0.4,0.1,0.2],doZakodowania)
